...
if __name__ == "__main__":
	...
	with tf.Session(config=tf_config) as sess:
		...
		for e in range(epoch):
			...
			print(f"save loss")
			np.save(os.path.abspath('.'), 'save_model', f'{store_dir}tight_losses'), tight_losses)
			np.save(os.path.abspath('.'), 'save_model', f'{store_dir}loss'), losses)
			np.save(os.path.abspath('.'), 'save_model', f'{store_dir}val_loss'),val_losses)
			np.save(os.path.abspath('.'), 'save_model', f'{store_dir}test_loss'), test_losses)
