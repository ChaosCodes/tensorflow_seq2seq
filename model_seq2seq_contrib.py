...
class Seq2seq(object):
	...
	def make_attention_decoder(self, decoder_cell, encoder_outputs, encoder_state):
	...
	def __init__(self, config, w2i_target, useAttention=True):
		...
		with tf.variable_scope("decoder", reuse=tf.AUTO_REUSE):
			...
			with tf.variable_scope("gru_cell"):
				...
				if useAttention:
						decoder_cell, decoder_initial_state = self.make_attention_decoder(decoder_cell, encoder_outputs, decoder_initial_state)
